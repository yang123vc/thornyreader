...
/* I commented out the following line because despite the fact that it is
 * disabled by preprocessor directive, the compiler still trying to find
 * file "config.h". And since it does not exist, we get an error. Acho.
 * #  include <config.h>
 */
