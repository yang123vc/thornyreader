...
#define THORNYREADER_VERSION "17.10.13.00"
 ...
 */
#define CONFIG_CRE_FONT_ANTIALIASING       	101
#define CONFIG_CRE_EMBEDDED_STYLES         	103
#define CONFIG_CRE_EMBEDDED_FONTS          	104

#define CONFIG_CRE_FONT_FACE_MAIN              105
#define CONFIG_CRE_FONT_FACE_FALLBACK      	106
/**
 * Supported: 0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.5, 1.9
 * See gammatbl.h
 */
#define CONFIG_CRE_FONT_GAMMA              	107
#define CONFIG_CRE_FONT_COLOR             		108
#define CONFIG_CRE_FONT_SIZE               	109
/**
 * Supported: 80, 85, 90, 95, 100, 105, 110, 115, 120, 130, 140, 150, 160, 180, 200
 */
#define CONFIG_CRE_INTERLINE_SPACE         	110
...
#define CONFIG_CRE_VIEWPORT_WIDTH        		117
#define CONFIG_CRE_VIEWPORT_HEIGHT     		118
